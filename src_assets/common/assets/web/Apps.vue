      ...
      <div class="modal-dialog modal-xl modal-dialog-scrollable modal-fullscreen-lg-down">
        <div class="modal-content" v-if="editForm">
          ...
          <div class="modal-body">
            ...
            <!-- display output override -->
            <div class="mb-3">
              <label for="appDisplayOutputName" class="form-label">{{ $t('apps.display_output_name') }}</label>
              <input type="text" class="form-control monospace" id="appDisplayOutputName" aria-describedby="appDisplayOutputNameHelp"
                     v-model="editForm['display-output-name']" />
              <div id="appDisplayOutputNameHelp" class="form-text">{{ $t('apps.display_output_name_desc') }}</div>
            </div>
            <!-- capture crop rect -->
            <div class="mb-3">
              <label for="appDisplayCaptureCrop" class="form-label">{{ $t('apps.display_capture_crop') }}</label>
              <input type="text" class="form-control monospace" id="appDisplayCaptureCrop" aria-describedby="appDisplayCaptureCropHelp"
                     v-model="editForm['display-capture-crop']" placeholder="x,y,width,height" />
              <div id="appDisplayCaptureCropHelp" class="form-text">{{ $t('apps.display_capture_crop_desc') }}</div>
            </div>
            <!-- per-app input overrides (tri-state: Inherit = use the instance's global setting) -->
            <div class="mb-3">
              <label for="appInputKeyboard" class="form-label">{{ $t('apps.input_keyboard') }}</label>
              <select id="appInputKeyboard" class="form-select" aria-describedby="appInputKeyboardHelp" v-model="editForm['keyboard']">
                <option :value="undefined">{{ $t('apps.input_inherit') }}</option>
                <option :value="true">{{ $t('apps.input_enabled') }}</option>
                <option :value="false">{{ $t('apps.input_disabled') }}</option>
              </select>
              <div id="appInputKeyboardHelp" class="form-text">{{ $t('apps.input_keyboard_desc') }}</div>
            </div>
            <div class="mb-3">
              <label for="appInputMouse" class="form-label">{{ $t('apps.input_mouse') }}</label>
              <select id="appInputMouse" class="form-select" aria-describedby="appInputMouseHelp" v-model="editForm['mouse']">
                <option :value="undefined">{{ $t('apps.input_inherit') }}</option>
                <option :value="true">{{ $t('apps.input_enabled') }}</option>
                <option :value="false">{{ $t('apps.input_disabled') }}</option>
              </select>
              <div id="appInputMouseHelp" class="form-text">{{ $t('apps.input_mouse_desc') }}</div>
            </div>
            <div class="mb-3">
              <label for="appInputController" class="form-label">{{ $t('apps.input_controller') }}</label>
              <select id="appInputController" class="form-select" aria-describedby="appInputControllerHelp" v-model="editForm['controller']">
                <option :value="undefined">{{ $t('apps.input_inherit') }}</option>
                <option :value="true">{{ $t('apps.input_enabled') }}</option>
                <option :value="false">{{ $t('apps.input_disabled') }}</option>
              </select>
              <div id="appInputControllerHelp" class="form-text">{{ $t('apps.input_controller_desc') }}</div>
            </div>
            <div class="mb-3" v-if="platform !== 'macos'">
              <label for="appGamepad" class="form-label">{{ $t('apps.gamepad') }}</label>
              <select id="appGamepad" class="form-select" aria-describedby="appGamepadHelp" v-model="editForm['gamepad']">
                <option :value="undefined">{{ $t('apps.gamepad_global') }}</option>
                <option value="auto">{{ $t('_common.auto') }}</option>
                <option value="ds4">{{ $t('config.gamepad_ds4') }}</option>
                <option value="x360">{{ $t('apps.gamepad_xbox') }}</option>
              </select>
              <div id="appGamepadHelp" class="form-text">{{ $t('apps.gamepad_desc') }}</div>
            </div>
            <div class="mb-3">
  ...
  export default {
    ...
    methods: {
      ...
      editApp(id) {
        ...
        if (this.editForm["gamepad"] === "") {
          this.editForm["gamepad"] = undefined;
        }
        this.openEditModal();
      },
      showDeleteModal(id) {
